...
=======
    public static void main(String[] args)
    {
>>>>>>> parent of 25a85a3... Testing script and helper methods half-implemented. It's already much larger than the original program, so I'm probably going to fork version 1.0 and have it output raw data to text files for analysis in Excel, instead of building analysis (and printouts) into the program itself.
        // Introduction.
        {
